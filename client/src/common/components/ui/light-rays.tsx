...
interface LightRaysProps extends React.HTMLAttributes<HTMLDivElement> {
  ...
  speed?: number;
  length?: string;
  // Nueva prop para variantes deportivas
  variant?: "football" | "basketball" | "extreme" | "default";
}
...
// Colores deportivos predefinidos
const SPORTS_COLORS = {
  football: "rgba(255, 140, 0, 0.25)", // Naranja energético
  basketball: "rgba(255, 60, 60, 0.3)", // Rojo vibrante
  extreme: "rgba(255, 220, 0, 0.2)", // Amarillo eléctrico
  default: "rgba(160, 210, 255, 0.2)", // Azul original
};
...
export function LightRays({
  ...
  style,
  count = 7,
  color, // Ahora es opcional porque usamos variant
  blur = 36,
  speed = 14,
  length = "70vh",
  variant = "default",
  ...
  // Usar color personalizado o el de la variante deportiva
  const rayColor = color || SPORTS_COLORS[variant];
